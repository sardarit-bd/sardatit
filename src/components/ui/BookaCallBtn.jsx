...
const BookaCallBtn = ({ isheader = false }) => {
    return (
        <Link
            href="/contact"
            className={`group inline-flex items-center gap-3 px-4 py-2.5 bg-slate-950 text-white font-semibold text-sm md:text-base  transition-all duration-300 hover:bg-slate-950  hover:scale-[1.02]  ${isheader ? "" : "shadow-xl shadow-slate-950/20"}`}
        >
