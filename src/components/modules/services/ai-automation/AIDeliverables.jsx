...
import { FiServer, FiGitMerge, FiFileText, FiShield } from "react-icons/fi";
...
const AUTOMATION_DELIVERABLES = [
  {
    ...
    sublabel: "Zero Per-Execution SaaS Fees",
    desc: "Private Dockerized n8n deployment on your own cloud (AWS/Hetzner) with zero recurring per-task fees and complete enterprise data privacy.",
  },
  {
    icon: FiGitMerge,
    title: "Custom Webhook & API Connectors",
    sublabel: "Real-Time Event Orchestration",
    desc: "Bi-directional webhook pipelines connecting CRMs, payment gateways, ERPs, and internal databases with automated retry mechanisms.",
  },
  {
    icon: FiFileText,
    title: "Intelligent Document (OCR/PDF) Pipelines",
    sublabel: "Automated Data Extraction",
    desc: "Multimodal AI parsing engines that automatically read invoices, shipping manifests, and PDF contracts, structuring data directly into your database.",
  },
  {
    icon: FiShield,
    title: "Full Workflow Blueprints & 100% IP Ownership",
    sublabel: "Production JSON Schemas & Runbooks",
    desc: "Complete workflow JSON blueprints, credential vaults, and disaster recovery runbooks transferred with 100% intellectual property ownership.",
  },
];

export default function AIDeliverables() {
